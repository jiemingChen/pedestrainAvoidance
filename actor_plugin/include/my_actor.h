...
#include <actor_plugin/SetPose.h>
...
namespace gazebo
{
  ...
  public: bool GetVelCallback(actor_plugin::GetVel::Request&, actor_plugin::GetVel::Response&);
  ...
  private: ignition::math::Vector3d velocity_real;
    ...
    private: ignition::math::Vector3d initial_pose;
    private: ignition::math::Vector3d initial_target;
